...
public class MessageVo implements Serializable {
    ...
    private Double vj; //瞬时流速

    private Double va; //平均流速
    ...
    public MessageVo(String id, String username, String phone, String stcd, Integer state, String stname, Double z, Double zb, Double zu, Double waterRanges, Double rainRanges, String content, Double pn05, Double pj, Double vj, Double va, Double q, Date tm) {
        this.id = id;
